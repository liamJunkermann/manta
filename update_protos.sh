...
rm -rf $DIR/gametoolevents.proto $DIR/dota_messages_mlbot.proto $DIR/dota_gcmessages_common_bot_script.proto $DIR/steammessages_base.proto $DIR/steammessages_clientserver_login.proto $DIR/*steamworks*.proto $DIR/tensorflow
