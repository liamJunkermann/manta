...
// 	protoc        v3.21.7
// source: dota_broadcastmessages_m.proto
...
func (EDotaBroadcastMessages) Descriptor() protoreflect.EnumDescriptor {
	return file_dota_broadcastmessages_m_proto_enumTypes[0].Descriptor()
}

func (EDotaBroadcastMessages) Type() protoreflect.EnumType {
	return &file_dota_broadcastmessages_m_proto_enumTypes[0]
}
...
func (EDotaBroadcastMessages) EnumDescriptor() ([]byte, []int) {
	return file_dota_broadcastmessages_m_proto_rawDescGZIP(), []int{0}
}
...
func (x *CDOTABroadcastMsg) Reset() {
	*x = CDOTABroadcastMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dota_broadcastmessages_m_proto_msgTypes[0]
...
func (x *CDOTABroadcastMsg_LANLobbyRequest) Reset() {
	*x = CDOTABroadcastMsg_LANLobbyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dota_broadcastmessages_m_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CDOTABroadcastMsg_LANLobbyRequest) Descriptor() ([]byte, []int) {
	return file_dota_broadcastmessages_m_proto_rawDescGZIP(), []int{1}
}
...
func (x *CDOTABroadcastMsg_LANLobbyReply) Reset() {
	*x = CDOTABroadcastMsg_LANLobbyReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dota_broadcastmessages_m_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CDOTABroadcastMsg_LANLobbyReply) Descriptor() ([]byte, []int) {
	return file_dota_broadcastmessages_m_proto_rawDescGZIP(), []int{2}
}
...
func (x *CDOTABroadcastMsg_LANLobbyReply_CLobbyMember) Reset() {
	*x = CDOTABroadcastMsg_LANLobbyReply_CLobbyMember{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dota_broadcastmessages_m_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CDOTABroadcastMsg_LANLobbyReply_CLobbyMember) Descriptor() ([]byte, []int) {
	return file_dota_broadcastmessages_m_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_dota_broadcastmessages_m_proto protoreflect.FileDescriptor

var file_dota_broadcastmessages_m_proto_rawDesc = []byte{
	,
	...
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x74, 0x6f, 0x75, 0x72, 0x6e,
	0x61, 0x6d, 0x65, 0x6e, 0x74, 0x47, 0x61, 0x6d, 0x65, 0x49, 0x64, 0x12, 0x4c, 0x0a, 0x07, 0x6d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x64,
	0x6f, 0x74, 0x61, 0x2e, 0x43, 0x44, 0x4f, 0x54, 0x41, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61,
	...
	0x41, 0x4e, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x10, 0x02, 0x42, 0x30,
...
var (
	file_dota_broadcastmessages_m_proto_rawDescOnce sync.Once
	file_dota_broadcastmessages_m_proto_rawDescData = file_dota_broadcastmessages_m_proto_rawDesc
)

func file_dota_broadcastmessages_m_proto_rawDescGZIP() []byte {
	file_dota_broadcastmessages_m_proto_rawDescOnce.Do(func() {
		file_dota_broadcastmessages_m_proto_rawDescData = protoimpl.X.CompressGZIP(file_dota_broadcastmessages_m_proto_rawDescData)
	})
	return file_dota_broadcastmessages_m_proto_rawDescData
}

var file_dota_broadcastmessages_m_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dota_broadcastmessages_m_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_dota_broadcastmessages_m_proto_goTypes = []interface{}{
...
var file_dota_broadcastmessages_m_proto_depIdxs = []int32{
...
func init() { file_dota_broadcastmessages_m_proto_init() }
func file_dota_broadcastmessages_m_proto_init() {
	if File_dota_broadcastmessages_m_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_dota_broadcastmessages_m_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dota_broadcastmessages_m_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dota_broadcastmessages_m_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dota_broadcastmessages_m_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dota_broadcastmessages_m_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dota_broadcastmessages_m_proto_goTypes,
		DependencyIndexes: file_dota_broadcastmessages_m_proto_depIdxs,
		EnumInfos:         file_dota_broadcastmessages_m_proto_enumTypes,
		MessageInfos:      file_dota_broadcastmessages_m_proto_msgTypes,
	}.Build()
	File_dota_broadcastmessages_m_proto = out.File
	file_dota_broadcastmessages_m_proto_rawDesc = nil
	file_dota_broadcastmessages_m_proto_goTypes = nil
	file_dota_broadcastmessages_m_proto_depIdxs = nil
}
