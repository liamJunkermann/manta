...
func (EBaseClientMessages) Descriptor() protoreflect.EnumDescriptor {
	return file_clientmessages_m_proto_enumTypes[0].Descriptor()
}

func (EBaseClientMessages) Type() protoreflect.EnumType {
	return &file_clientmessages_m_proto_enumTypes[0]
}
...
func (EBaseClientMessages) EnumDescriptor() ([]byte, []int) {
	return file_clientmessages_m_proto_rawDescGZIP(), []int{0}
}
...
func (EClientUIEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_clientmessages_m_proto_enumTypes[1].Descriptor()
}

func (EClientUIEvent) Type() protoreflect.EnumType {
	return &file_clientmessages_m_proto_enumTypes[1]
}
...
func (EClientUIEvent) EnumDescriptor() ([]byte, []int) {
	return file_clientmessages_m_proto_rawDescGZIP(), []int{1}
}
...
func (x *CClientMsg_CustomGameEvent) Reset() {
	*x = CClientMsg_CustomGameEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clientmessages_m_proto_msgTypes[0]
...
func (x *CClientMsg_CustomGameEventBounce) Reset() {
	*x = CClientMsg_CustomGameEventBounce{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clientmessages_m_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *CClientMsg_ClientUIEvent) Reset() {
	*x = CClientMsg_ClientUIEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clientmessages_m_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_ClientUIEvent) Descriptor() ([]byte, []int) {
	return file_clientmessages_m_proto_rawDescGZIP(), []int{2}
}
...
func (x *CClientMsg_DevPaletteVisibilityChangedEvent) Reset() {
	*x = CClientMsg_DevPaletteVisibilityChangedEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clientmessages_m_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_DevPaletteVisibilityChangedEvent) Descriptor() ([]byte, []int) {
	return file_clientmessages_m_proto_rawDescGZIP(), []int{3}
}
...
func (x *CClientMsg_WorldUIControllerHasPanelChangedEvent) Reset() {
	*x = CClientMsg_WorldUIControllerHasPanelChangedEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clientmessages_m_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_WorldUIControllerHasPanelChangedEvent) Descriptor() ([]byte, []int) {
	return file_clientmessages_m_proto_rawDescGZIP(), []int{4}
}
...
func (x *CClientMsg_RotateAnchor) Reset() {
	*x = CClientMsg_RotateAnchor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_clientmessages_m_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CClientMsg_RotateAnchor) Descriptor() ([]byte, []int) {
	return file_clientmessages_m_proto_rawDescGZIP(), []int{5}
}
...
var File_clientmessages_m_proto protoreflect.FileDescriptor

var file_clientmessages_m_proto_rawDesc = []byte{
	0x0a, 0x16, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73,
	0x5f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x64, 0x6f, 0x74, 0x61, 0x22, 0x4f,
	0x0a, 0x1a, 0x43, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4d, 0x73, 0x67, 0x5f, 0x43, 0x75, 0x73,
	...
	0x76, 0x0a, 0x20, 0x43, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4d, 0x73, 0x67, 0x5f, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x47, 0x61, 0x6d, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x6f, 0x75,
	0x6e, 0x63, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6e, 0x61, 0x6d,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72,
	0x5f, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x70, 0x6c, 0x61,
	0x79, 0x65, 0x72, 0x53, 0x6c, 0x6f, 0x74, 0x22, 0xba, 0x01, 0x0a, 0x18, 0x43, 0x43, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x4d, 0x73, 0x67, 0x5f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x49, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x64, 0x6f, 0x74, 0x61, 0x2e, 0x45, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x55, 0x49, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74,
...
var (
	file_clientmessages_m_proto_rawDescOnce sync.Once
	file_clientmessages_m_proto_rawDescData = file_clientmessages_m_proto_rawDesc
)

func file_clientmessages_m_proto_rawDescGZIP() []byte {
	file_clientmessages_m_proto_rawDescOnce.Do(func() {
		file_clientmessages_m_proto_rawDescData = protoimpl.X.CompressGZIP(file_clientmessages_m_proto_rawDescData)
	})
	return file_clientmessages_m_proto_rawDescData
}

var file_clientmessages_m_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_clientmessages_m_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_clientmessages_m_proto_goTypes = []interface{}{
...
var file_clientmessages_m_proto_depIdxs = []int32{
...
func init() { file_clientmessages_m_proto_init() }
func file_clientmessages_m_proto_init() {
	if File_clientmessages_m_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_clientmessages_m_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_clientmessages_m_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_clientmessages_m_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_clientmessages_m_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_clientmessages_m_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_clientmessages_m_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_clientmessages_m_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_clientmessages_m_proto_goTypes,
		DependencyIndexes: file_clientmessages_m_proto_depIdxs,
		EnumInfos:         file_clientmessages_m_proto_enumTypes,
		MessageInfos:      file_clientmessages_m_proto_msgTypes,
	}.Build()
	File_clientmessages_m_proto = out.File
	file_clientmessages_m_proto_rawDesc = nil
	file_clientmessages_m_proto_goTypes = nil
	file_clientmessages_m_proto_depIdxs = nil
}
